...
from lib.common.utils import UTF8, MODE_TRA_TICKET
...
from lib.ticket.utils import TICKET_CMD_QUERY, TICKET_CMD_RESET, TICKET_HEADERS_BOOKED_TRA, TICKET_RETRY, TICKET_STATUS_PAY
